...
QPSK Modulated Signal: The phase-shifted signal based on input bit pairs.

Demodulated Signal: The reconstructed binary data from the modulated signal.


![image](https://github.com/user-attachments/assets/37632dbc-39ce-4416-a500-4e9293623a53)

# Results

The binary data was successfully encoded using QPSK modulation.
The demodulation process decoded the original message signal from the modulated wave.
The output shows the QPSK modulated signal and the demodulated signal matching the input binary data.
